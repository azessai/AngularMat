...
import { TableAzDataSource, TableAzItem } from './table-az-datasource';

@Component({
  selector: 'app-table-az',
  templateUrl: './table-az.component.html',
...
export class TableAzComponent implements AfterViewInit, OnInit {
  ...
  ngOnInit() {
    this.dataSource = new TableAzDataSource();
  }
